...
function lines_dict(recipe::CRecipe{T}) where T <: WP9Type1IR
    @track_recipe
    out = @invoke lines_dict(recipe::CRecipe{<: Type1})

    add_line!(recipe, out, :HeI_10832, NarrowLine, BroadLine)
    add_line!(recipe, out, :SIII_9069)
    add_line!(recipe, out, :SIII_9532)
    add_line!(recipe, out, :Paa, NarrowLine)
    add_line!(recipe, out, :Pab, NarrowLine)
    add_line!(recipe, out, :Pag, NarrowLine)
    add_line!(recipe, out, :Pad, NarrowLine)
    add_line!(recipe, out, :Pa8, NarrowLine)
    add_line!(recipe, out, :Pa9, NarrowLine)
    add_line!(recipe, out, :OI_8448, NarrowLine, BroadLine)
