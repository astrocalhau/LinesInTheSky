...
let
    ...
    push!(accum, stephist(log10.(euclid[qc.Pab , :Pab_br_norm])       .+ 42, label=L"\mathrm{Pa}\beta"; color=ith_color(length(accum)+1), SERIES_OPTS..., xlabel=L"\log_{10}(L_{\mathrm{line}}/\mathrm{erg\ s^{-1}})", bottom_margin=(-1., :mm)))
...
let
    ...
    push!(accum, stephist(log10.(euclid[qc.Pab , :Pab_br_fwhm])      , label=L"\mathrm{Pa}\beta"; color=ith_color(5), SERIES_OPTS..., xlabel=L"\log_{10}(\mathrm{FWHM/km\ s^{-1}})", bottom_margin=(-1., :mm)))
    ...
    push!(accum, stephist(       euclid[qc.Pab , :Pab_br_voff]       , label=L"\mathrm{Pa}\beta"; color=ith_color(5), SERIES_OPTS..., xlabel=L"\mathrm{V_{off}/km\ s^{-1}}", bottom_margin=(-1., :mm)))
